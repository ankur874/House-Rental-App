...
import 'package:house_rental_app/Detail&RequestService/Views/DetailsScreen.dart';
...
class PropertyCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        Get.to(DetailsScreen(property_id: property.sId!));
      },
      child: Container(
              ...
              child: Column(
                ...
                children: [
                  Row(children: [
                    ...
                    Text(
                      property.rating == null ? "" : property.rating.toString(),
                    ...
                    Text(
                      "(${property.reviews == null ? "" : property.reviews?.length})",
                      style: TextStyle(
